<template>
    <div class="p-10">
        ...
        <div
            ...
            <div :style="`--tw-rotate: calc(${chartValue}deg - 45deg); transform: translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y));`"
